<template>
    Components Bouteille Edit
     <!-- <form @submit.prevent='updateBouteille(uneBouteille)'> 
    
        <div>
          <label for="catalogue-type">Type:</label>
          <input v-model="uneBouteille.vino__type_id" id="catalogue-type" type="number" min="1" max="2">
          <div class="text-red">
        ...
        <!-- <div>
          ...
          <input v-model="uneBouteille.nom" id="catalogue-nom" type="text">
          <div class="text-red">
        ...
        <!-- <div>
          ...
          <input v-model="uneBouteille.image" id="catalogue-image" type="text">
          <div class="text-red">
        ...
        <!-- <div>
          ...
          <input v-model="uneBouteille.pays" id="catalogue-pays" type="text">
          <div class="text-red">
        ...
        <!-- <div>
          ...
          <input v-model="uneBouteille.description" id="catalogue-description" type="text">
          <div class="text-red">
        ...
        <!-- <div>
          ...
          <input v-model="uneBouteille.prix_saq" id="catalogue-prix_saq" type="text">
          <div class="text-red">
        ...
        <!-- <div>
          ...
          <input v-model="uneBouteille.format" id="catalogue-format" type="text">
          <div class="text-red">
...
//  //import useBouteille from "../composables/bouteille.js";
...
//         onMounted(()=> {
//             getUneBouteille(route.params.id)
//             console.log('une bouteille du cellier dans edit');
